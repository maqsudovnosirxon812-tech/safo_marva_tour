...
public class SafoMarvaTourApplication {
    ...
    private static final Set<String> ACTIVE_PACKAGE_KEYS = Set.of(
            "special_14day", "comfort_plus_10", "comfort_14", "comfort_plus_14", "standard_13", "al_jabri_14",
    ...
    public CommandLineRunner syncPackages(PackageRepository packageRepository) {
        return args -> {
            ...
            upsertPackage(packageRepository, "comfort_plus_10", "comfort_14", "Comfort (14 kunlik)", "1450",
