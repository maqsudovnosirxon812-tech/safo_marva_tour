...
@Component
public class LeadTelegramBot extends TelegramLongPollingBot {
    ...
    public LeadTelegramBot(
            ...
            @Value("${bot.leadToken}") String botToken,
        ...
        initializeKeyboards();
        System.out.println("🤖 [DIAGNOSTIC] LeadTelegramBot loaded parameters successfully:");
